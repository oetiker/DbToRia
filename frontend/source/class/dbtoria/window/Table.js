    ...
    members : {
        ...
        generateForm : function(values) {
            ...
            for (var i=0; i<tableStructure.length; i++) {
                ...
                this.__formFields[formElement.id] = {
                    changed    : false,
                    primaryKey : formElement.primaryKey,
                    oldValue   : values[formElement.id]
                };
                ...
                if (!formElement.references) {
                    ...
                    switch(formElement.type)
                    {
                        case "datetime":
                            case "timestamp":
                                ...
                                form.add(new qx.ui.basic.Label(formElement.name), {
                                    row    : rowCount,
                                    column : 0
                                });
                            ...
                            case "boolean":
                                ...
                                checkBox.set({ name : formElement.name });
                            ...
                            case "float":
                                ...
                                default:
                                    ...
                                    form.add(new qx.ui.basic.Label(formElement.name + "[" + formElement.type + "]"), {
                                        row    : rowCount,
                                        column : 0
                                    });
                                ...
                                case "varchar":
                                    case "integer":
                                        ...
                                        button.addListener("execute", function(e) {
                                            var referenceWindow = new dbtoria.window.Table(this.formElement.references.table, this.formElement.references.table, this.application, "reference", this.formElement, this.callingWindow);
                                        }, {
                                    ...
                                    default:
                                        ...
                                        form.add(new qx.ui.basic.Label(formElement.name + "[" + formElement.type + "] REFERENCE"), {
                                            row    : rowCount,
                                            column : 0
                                        });
                     ...
                     *
                     * @param referencedFormElement {var} TODOC
                    ...
                    setReferenceToolTip : function(formElement) {
                        ...
                        if (refValue) {
                            var referencedData = this.__dbTable.getReferencedDataForKey(formElement.references.table, formElement.references.field, refValue);
                    ...
                    updateToolTip : function() {
                        ...
                        var referencedData = this.__dbTable.getReferencedDataForKey(column.references.table, column.references.field, this.__table.getTableModel().getValue(this.__cellEvent.getColumn(), this.__cellEvent.getRow()));
